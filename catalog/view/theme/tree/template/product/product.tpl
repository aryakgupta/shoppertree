...
<div class="container">
  ...
  <div class="row" style="margin:0;"><?php echo $column_left; ?>
          ...
          <div id="product">
            ...
            <div class="form-group">
              <div class="row">
               ...
               <label class="control-label label-qnaty" for="input-quantity">Quantity</label>
              <input type="text" name="quantity" value="<?php echo $minimum; ?>" size="2" id="input-quantity" class="form-control quantyyt" />
              <input type="hidden" name="product_id" value="<?php echo $product_id; ?>" class="quantyyt"/></div>
              <div class="col-md-6 col-xs-6 col-lg-6 col-sm-6">
...
<figcaption><?php echo $product['name']; ?></figcaption>
        ...
        <?php if($ans!=''){ ?><br><span class="web_pertage-off"><?php echo $ans."% Off";?></span><?php } ?>
        <?php } ?></figcaption>
      </a></div>
