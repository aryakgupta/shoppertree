...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="currency">
  <div class="btn-group">
    ...
    <?php if($currency['code']=='IND')
        { ?>
        <img src="<?php echo HTTP_SERVER ?>image/flags/in.png">
        <?php
        }
        else {  ?>
        <img src="<?php echo HTTP_SERVER ?>image/flags/us.png">
        <?php } ?>
    <?php } ?>
    ...
    <ul class="dropdown-menu">
      ...
      <li><button class="currency-select btn btn-link btn-block" type="button" name="<?php echo $currency['code']; ?>"><?php //echo $currency['symbol_left']; ?> <?php //echo $currency['title']; ?>
<?php if($currency['code']=='IND')
        { ?>
        <img src="<?php echo HTTP_SERVER ?>image/flags/in.png">
        <?php
